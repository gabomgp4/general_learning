...
export class Output extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'kubernetes:logging.banzaicloud.io/v1beta1:Output';
    ...
    public readonly kind!: pulumi.Output<"Output">;
    public readonly metadata!: pulumi.Output<ObjectMeta>;
    public readonly spec!: pulumi.Output<outputs.logging.v1beta1.OutputSpec>;
    public readonly status!: pulumi.Output<outputs.logging.v1beta1.OutputStatus>;
...
export interface OutputArgs {
    ...
    readonly kind?: pulumi.Input<"Output">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    readonly spec?: pulumi.Input<inputs.logging.v1beta1.OutputSpec>;
    readonly status?: pulumi.Input<inputs.logging.v1beta1.OutputStatus>;
}
