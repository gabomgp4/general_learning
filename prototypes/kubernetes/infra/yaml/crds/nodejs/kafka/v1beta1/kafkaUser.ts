...
export class KafkaUser extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KafkaUser {
        return new KafkaUser(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kafka.strimzi.io/v1beta1:KafkaUser';
    ...
    public readonly kind!: pulumi.Output<"KafkaUser">;
    public readonly metadata!: pulumi.Output<ObjectMeta>;
    /**
     * The specification of the user.
     */
    public readonly spec!: pulumi.Output<outputs.kafka.v1beta1.KafkaUserSpec>;
    /**
     * The status of the Kafka User.
     */
    public readonly status!: pulumi.Output<outputs.kafka.v1beta1.KafkaUserStatus>;
    ...
    constructor(name: string, args?: KafkaUserArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KafkaUser.__pulumiType, name, inputs, opts);
    }
}
...
export interface KafkaUserArgs {
    ...
    readonly kind?: pulumi.Input<"KafkaUser">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * The specification of the user.
     */
    readonly spec?: pulumi.Input<inputs.kafka.v1beta1.KafkaUserSpec>;
    /**
     * The status of the Kafka User.
     */
    readonly status?: pulumi.Input<inputs.kafka.v1beta1.KafkaUserStatus>;
}
