...
export class KafkaTopic extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): KafkaTopic {
        return new KafkaTopic(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'kubernetes:kafka.strimzi.io/v1beta1:KafkaTopic';
    ...
    public readonly kind!: pulumi.Output<"KafkaTopic">;
    public readonly metadata!: pulumi.Output<ObjectMeta>;
    /**
     * The specification of the topic.
     */
    public readonly spec!: pulumi.Output<outputs.kafka.v1beta1.KafkaTopicSpec>;
    /**
     * The status of the topic.
     */
    public readonly status!: pulumi.Output<outputs.kafka.v1beta1.KafkaTopicStatus>;
...
export interface KafkaTopicArgs {
    ...
    readonly kind?: pulumi.Input<"KafkaTopic">;
    readonly metadata?: pulumi.Input<ObjectMeta>;
    /**
     * The specification of the topic.
     */
    readonly spec?: pulumi.Input<inputs.kafka.v1beta1.KafkaTopicSpec>;
    /**
     * The status of the topic.
     */
    readonly status?: pulumi.Input<inputs.kafka.v1beta1.KafkaTopicStatus>;
}
