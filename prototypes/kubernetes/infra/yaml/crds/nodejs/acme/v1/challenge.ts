...
export class Challenge extends pulumi.CustomResource {
    ...
    public readonly status!: pulumi.Output<outputs.acme.v1.ChallengeStatus>;
...
export interface ChallengeArgs {
    ...
    readonly spec?: pulumi.Input<inputs.acme.v1.ChallengeSpec>;
    readonly status?: pulumi.Input<inputs.acme.v1.ChallengeStatus>;
}
