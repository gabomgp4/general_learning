...
export class KongPlugin extends pulumi.CustomResource {
    ...
    public readonly configFrom!: pulumi.Output<outputs.configuration.v1.KongPluginConfigFrom>;
    public readonly disabled!: pulumi.Output<boolean>;
    public readonly kind!: pulumi.Output<"KongPlugin">;
    ...
    constructor(name: string, args?: KongPluginArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(KongPlugin.__pulumiType, name, inputs, opts);
    }
}
...
export interface KongPluginArgs {
    ...
    readonly configFrom?: pulumi.Input<inputs.configuration.v1.KongPluginConfigFrom>;
    readonly disabled?: pulumi.Input<boolean>;
    readonly kind?: pulumi.Input<"KongPlugin">;
